...
OrbitalProperty::OrbitalProperty(QWidget *parent): QDialog(parent)
{
    ...
    proj3d=m_parent->getProj3D();
    angular3d=m_parent->getAngular3D();
    radial3d=m_parent->getRadial3D();
...
void OrbitalProperty::initial()
{
    ...
    backgroundcolor=255*view3d->getBackgroundColor();
    background_red=backgroundcolor.x();
    background_green=backgroundcolor.y();
    background_blue=backgroundcolor.z();
    ...
    ui.spinBox_background_red->setValue(background_red);
    ui.spinBox_background_green->setValue(background_green);
    ui.spinBox_background_blue->setValue(background_blue);

    QString bs=tr("background-color: rgb(%1,%2,%3);").arg(background_red).arg(background_green).arg(background_blue);
    ui.pushButton_Background->setStyleSheet(bs);
...
void OrbitalProperty::getDataFromCurrentPanel()
{
    ...
    background_red=ui.spinBox_background_red->value();
    background_green=ui.spinBox_background_green->value();
    background_blue=ui.spinBox_background_blue->value();
}
...
void OrbitalProperty::refreshView3d()
{
    ...
    //background color
    view3d->setBackgroundColor(vector3(background_red/a, background_green/a, background_blue/a));
    angular3d->setBackgroundColor(vector3(background_red/a, background_green/a, background_blue/a));
    proj3d->setBackgroundColor(vector3(background_red/a, background_green/a, background_blue/a));
    radial3d->setBackgroundColor(vector3(background_red/a, background_green/a, background_blue/a));

    //re-draw
    m_parent->refreshViews();
}
...
void OrbitalProperty::on_pushButton_Background_clicked()
{
    QColor color(background_red, background_green, background_blue);

    QColor c=QColorDialog::getColor(color, this);
    if (!c.isValid()) return;
    background_red=c.red();
    background_green=c.green();
    background_blue=c.blue();

    ui.spinBox_background_red->setValue(background_red);
    ui.spinBox_background_green->setValue(background_green);
    ui.spinBox_background_blue->setValue(background_blue);

    QString s=tr("background-color: rgb(%1,%2,%3);").arg(background_red).arg(background_green).arg(background_blue);
    ui.pushButton_Background->setStyleSheet(s);
}

void OrbitalProperty::on_spinBox_background_red_valueChanged(int arg1)
{
    background_red=arg1;
    QString s=tr("background-color: rgb(%1,%2,%3);").arg(background_red).arg(background_green).arg(background_blue);
    ui.pushButton_Background->setStyleSheet(s);
...
void OrbitalProperty::on_spinBox_background_green_valueChanged(int arg1)
{
    background_green=arg1;
    QString s=tr("background-color: rgb(%1,%2,%3);").arg(background_red).arg(background_green).arg(background_blue);
    ui.pushButton_Background->setStyleSheet(s);
}

void OrbitalProperty::on_spinBox_background_blue_valueChanged(int arg1)
{
    background_blue=arg1;
    QString s=tr("background-color: rgb(%1,%2,%3);").arg(background_red).arg(background_green).arg(background_blue);
    ui.pushButton_Background->setStyleSheet(s);
}
